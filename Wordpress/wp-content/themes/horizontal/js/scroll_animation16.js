...
$(window).on("load resize",function(e){
	...
	var winWidth = $(window).width();    //window width
	 ...
	 var NAVPADPERCENT = 0.03; //this determines the padding of the nav links
   	 ...
   	 if ( winWidth >= 500 && winWidth < 780 && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
   	 ...
   	 } else if ( winWidth < 500 && /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
		...
		winWidth = $(window).width();    //window width
	 	...
	 	$(".background").css("background-position", "center");
   	 	...
   	 	panelHeight = winHeight - parseFloat($("header").css("height")) - parseFloat($(".site-info").css("height")) ; //the panel height
   	 	panMarg = 20;
   	 	$(".panel").css("margin-left", panMarg);
   	 ...
   	 if ( winWidth < 500 && /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	//when you are already on a link, slide to that stuff
   	...
   	$("#menu-main-menu a").bind("click",function(event) {
   		...
   		if ( winWidth < 500 && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
